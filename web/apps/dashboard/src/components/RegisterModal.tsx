  ...
  return (
    <Dialog open={open} onOpenChange={v => (v ? reset() : onOpenChange(false))}>
      <DialogContent className="max-w-2xl">
                    ...
                    <div key={p.name} className="flex flex-col gap-1">
                      ...
                      {p.type === "select" ? (
                        <Select
                          ...
                          onValueChange={v =>
                            patchStage(st.id, { values: { ...st.values, [p.name]: v } })
                          }
                        >
                        ...
                        <Input
                          ...
                          onChange={e =>
                            patchStage(st.id, {
                              values: { ...st.values, [p.name]: e.target.value },
                            })
                          }
                        />
                      )}
        ...
        {err && (
          <div className="border-destructive/30 bg-destructive/10 text-destructive rounded-md border p-2 text-xs whitespace-pre-wrap">
            {err}
          </div>
        )}
        {ok && (
